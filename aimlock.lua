--[[
 ...
 ________  ________  ________  ___       __   ________  ________  _______      
|\   __  \|\   __  \|\   __  \|\  \     |\  \|\   __  \|\   __  \|\  ___ \     
\ \  \|\  \ \  \|\  \ \  \|\ /\ \  \    \ \  \ \  \|\  \ \  \|\  \ \   __/|    
 \ \  \\\  \ \   _  _\ \   __  \ \  \  __\ \  \ \   __  \ \   _  _\ \  \_|/__  
  \ \  \\\  \ \  \\  \\ \  \|\  \ \  \|\__\_\  \ \  \ \  \ \  \\  \\ \  \_|\ \ 
   \ \_______\ \__\\ _\\ \_______\ \____________\ \__\ \__\ \__\\ _\\ \_______\
    \|_______|\|__|\|__|\|_______|\|____________|\|__|\|__|\|__|\|__|\|_______|
...
disclaimer; do not care if you get caught using this, you're responsible for what you do
with this.
...
LeftGroupBox:AddDropdown('aimbotKeybind', {
...
LeftGroupBox:AddToggle('useMouseMoverelToggle', {
	Text = 'use mousemoverel',
	Default = true, -- Default value (true / false)
	Tooltip = 'if disabed, cameras rotation will be modified to face towards the character', -- Information shown when you hover over the toggle
})
...
RightGroupBox:AddDropdown('whitelistPlayers', {
	-- Default is the numeric index (e.g. "This" would be 1 since it if first in the values list)
	-- Default also accepts a string as well

	-- Currently you can not set multiple values with a dropdown

	Values = (function() local t = {} for _, Player in next, PlayerServ:GetPlayers() do if Player ~= Client then table.insert(t, Player.Name) end end return t end)(),
	Default = 1, 
	Multi = true, -- true / false, allows multiple choices to be selected

	Text = 'whitelist players',
	Tooltip = 'players selected here will not be locked onto', -- Information shown when you hover over the textbox
})
...
Options.whitelistPlayers:OnChanged(function()
	...
	for key, value in next, Options.whitelistPlayers.Value do
		local type = "Other"
		aimbot:Set(type, "Whitelisted", key, value)
	end
end)
...
Toggles.useMouseMoverelToggle:OnChanged(function()
	local type = "Aimbot"
	aimbot:Set(type, "Use_mousemoverel", Toggles.useMouseMoverelToggle.Value)
end)
...
ESPLeftGroupBox:AddToggle('espNameDistanceText', {
	Text = 'distance text',
	Default = false, -- Default value (true / false)
	Tooltip = 'enables/disables distance text', -- Information shown when you hover over the toggle
})


Toggles.espNameDistanceText:OnChanged(function()
	espLib.options.distance = Toggles.espNameDistanceText.Value
end)
